...
export class WorkoutCommentsComponent implements OnInit {
  ...
  postComment() {
    ...
    if (this.commentData == null) {
      ...
      // console.log(userId);
      this.commentsService.newComment(this.userId, this.comment.value.comments, this.comment.value.rating, this.id).subscribe();
      location.reload();
    }
